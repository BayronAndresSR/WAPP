...
public class MainActivity extends AppCompatActivity {
    ...
    private static String DIRECTION = "www.udemy.com/";
    ...
    private void createSnackbar(){
        Snackbar snackbar = Snackbar.make(constraintLayout, "Hola Bienvenido a UDEMY la plataforma de aprendizaje en linea", Snackbar.LENGTH_LONG)
